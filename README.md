...
For macOS and Linux — Windows isn't supported ([here's why, and where to upvote](https://github.com/julianbei/arno/issues/2)).
...
[issue #2](https://github.com/julianbei/arno/issues/2) or tell us there why it
...
- **Repeatable commands:** have the agent `declare_command` something you run
  ...
  reuse it from `.arno/commands.json`.
...
**Windows** isn't supported — see [issue #2](https://github.com/julianbei/arno/issues/2),
...
are installed and installs the rest ([Language servers](#language-servers-arno-mcp-install)).
