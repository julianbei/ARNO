...
func TestCheckListsProjectsAndTakesATarget(t *testing.T) {
	...
	out, err = callText(t, server, "jade.check", map[string]interface{}{"kind": "build", "dryRun": true, "target": "api"})
	if err != nil {
		t.Fatal(err)
	}
	...
	if _, err := callText(t, server, "jade.check", map[string]interface{}{"kind": "build", "dryRun": true, "target": "../elsewhere"}); err == nil {
