...
func TestEveryPathToolRefusesToLeaveTheWorkspace(t *testing.T) {
	...
	tools := map[string]func(path string) map[string]interface{}{
		"arno.outline":    func(p string) map[string]interface{} { return map[string]interface{}{"path": p} },
		"arno.read_range": func(p string) map[string]interface{} { return map[string]interface{}{"path": p, "startLine": 1} },
		"arno.references": func(p string) map[string]interface{} {
			return map[string]interface{}{"path": p, "symbolName": "Secret"}
		},
		"arno.rename": func(p string) map[string]interface{} {
			return map[string]interface{}{"path": p, "symbolName": "Secret", "newName": "Leaked"}
		},
		"arno.context": func(p string) map[string]interface{} {
			return map[string]interface{}{"path": p, "symbolName": "Secret"}
		},
		"arno.history": func(p string) map[string]interface{} {
			return map[string]interface{}{"path": p, "symbolName": "Secret"}
		},
		"arno.replace_text": func(p string) map[string]interface{} {
			return map[string]interface{}{"path": p, "oldText": "return 1", "newText": "return 2"}
		},
		"arno.insert":       func(p string) map[string]interface{} { return map[string]interface{}{"path": p, "text": "// leaked"} },
		"arno.replace_file": func(p string) map[string]interface{} { return map[string]interface{}{"path": p, "content": "leaked"} },
		"arno.delete_symbol": func(p string) map[string]interface{} {
			return map[string]interface{}{"path": p, "symbolName": "Secret"}
		},
		"arno.delete_file": func(p string) map[string]interface{} { return map[string]interface{}{"path": p} },
		"arno.replace_symbol": func(p string) map[string]interface{} {
			return map[string]interface{}{"symbolId": p + "::Secret@3", "newCode": "func Secret() int { return 2 }"}
		},
		"arno.apply": func(p string) map[string]interface{} {
	...
	for escape, path := range map[string]string{
		...
		if _, err := callText(t, server, "arno.create_file", map[string]interface{}{"path": path, "content": "leaked"}); err == nil {
...
func TestWalksDoNotReadThroughAnEscapingSymlink(t *testing.T) {
	...
	for tool, args := range map[string]map[string]interface{}{
		"arno.grep": {"query": "OutsideOnlyName"},
		"arno.find": {"query": "OutsideOnlyName"},
	} {
